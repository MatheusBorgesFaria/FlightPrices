...
# Create a database
sudo -i -u postgres psql < sql/flight_database_config.sql
sudo -i -u postgres psql < sql/create_index.sql
sudo -i -u postgres psql < sql/create_views.sql
sudo -i -u postgres psql < sql/create_functions.sql
